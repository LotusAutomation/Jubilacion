...
public class RutaJson {
	...
	// devolver una lista de archivo List<File> public static List<String> rutaArchivoJson() {
	public static List<String> rutaArchivoJson() {
		// Aquí la carpeta que queremos explorar
		String path = SerenityProperties.sPATH_JSON_FILE;
		String pathOut = "";
	//	String pathGZ = "";
		...
		*/
		...
		/*
					if(files.endsWith(".gz")) {
						pathGZ = path + files;
						try {
							Descomprime.archivoGZip(pathGZ, path);
						} catch (Exception e) {
							e.printStackTrace();
							System.out.println("El archivo" + path +".gz no pudo ser descomprimido ");
						}*/
