...
public class Checksum {
	...
	/*
	 * public static boolean readLinesFile(String path, String ChecksumJson, String
	 * UniversalId) { // Mapa para almacenar todo lo contenido en el archivo .txt
	 * HashMap<String, String> hash_map = new HashMap<String, String>();
	 * BufferedReader reader; String line = ""; String separador = ""; try { reader
	 * = new BufferedReader(new FileReader(path)); while (reader != null) { //
	 * System.out.println(line); // read next line line = reader.readLine(); if(line
	 * != null) { // System.out.println("ERRORread::. " + line); // Leer el archivo
	 * de anexos y separador = Pattern.quote("|"); String[] arrOnlyFileMD5 =
	 * line.split(separador); // Llenar el mapa con los datos del .txt de anexos //
	 * Mapping string values to int keys hash_map.put(arrOnlyFileMD5[0],
	 * arrOnlyFileMD5[1]); }else { reader.close(); } } // resultExtracMD5 =
	 * extractFileMD5(hash_map, ChecksumJson, UniversalId); } catch (IOException e)
	 * { System.out.println(".::ERRORreadLinesFile::. " + e); } return
	 * extractFileMD5(hash_map, ChecksumJson, UniversalId); }
	 */
