...
public class SerenityProperties {
	...
	//Variable que almacena la ubicación del Json Local
	public static String sPATH_ANEXO_FILE = SystemEnvironmentVariables.createEnvironmentVariables().getProperty("PATH_ANEXO_FILE");
	
	//Variable que almacena la ubicación del Json Local
	public static String sPATH_JSON_FILE = SystemEnvironmentVariables.createEnvironmentVariables().getProperty("PATH_JSON_FILE");

	//Variable que almacena la ubicación del Xml Local, faltando el nombre del archivo
	public static String sPATH_XML_FILE = SystemEnvironmentVariables.createEnvironmentVariables().getProperty("PATH_XML_FILE");
	
	//Variable que almacena la ubicación del Log Local, con el nombre del archivo
	public static String sPATH_LOG_FILE = SystemEnvironmentVariables.createEnvironmentVariables().getProperty("PATH_LOG_FILE");
	
	//Variable que almacena la ubicación del Log Local, con el nombre del archivo
	public static String sPATH_TXT_FILE = SystemEnvironmentVariables.createEnvironmentVariables().getProperty("PATH_TXT_FILE");
	...
	//Variable que almacena la contraseña para acceder al Lotus
